    ...
    for epoch in range(0,opt.nepoch):
        ...
        if opt.generalized:
            ...
            if best_gzsl_acc < gzsl_cls.H:
                ...
                np.save("./tfvaegan_feat.npy", syn_feature.data.cpu().numpy())
                np.save("./tfvaegan_label.npy", syn_label.data.cpu().numpy())
                ...
                savemat("tfvaegan_data.mat", mydata)
                print("tfvaegan_data.mat is saved!")

            print('GZSL: seen=%.3f, unseen=%.3f, h=%.3f, best_seen=%.3f, best_unseen=%.3f, best_h=%.3f, run_time=%.3f'
        ...
        print('unseen class accuracy= %.4f, best_t=%.4f, run_time=%.3f' % (acc, best_zsl_acc, run_time2))
